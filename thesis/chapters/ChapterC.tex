...
\begin{pics}[htpb]{图像相似度测度方法比较}{WinComparation}
  \addsubpic{原图}{width=0.45\textwidth}{WinBefore}
  \addsubpic{校正后的结果}{width=0.45\textwidth}{WinAfter}
\end{pics}
...
\pic[htpb]{多分辨率配准策略\citeup{ITKBookDevelop}}%
...
应用与图谱图像的结果。
\begin{pics}[htpb]{多步骤配准}{RegistrationMultiProcess}
  \addsubpic{图谱图像}{width=0.3\textwidth}{RegistrationAtlasImage}
  \addsubpic{只使用仿射变换}{width=0.3\textwidth}{RegistrationAffineOnly}\\
  \addsubpic{使用非刚性形变模型}{width=0.3\textwidth}%
    {RegistrationWarpedAtlasImage}
  \addsubpic{目标图像}{width=0.3\textwidth}{RegistrationTarget}
\end{pics}
...
\begin{pics}[htpb]{图像相似度测度方法比较}{RegistrationExample}
  \addsubpic{图谱图像}{width=0.3\textwidth}{RegistrationAtlasImage}
  \addsubpic{待配准图像}{width=0.3\textwidth}{RegistrationTarget}
  \addsubpic{变形的图谱图像}{width=0.3\textwidth}{RegistrationWarpedAtlasImage}
  \addsubpic{图谱标签}{width=0.3\textwidth}{RegistrationAtlasLabel}
  \addsubpic{配准产生的变形}{width=0.3\textwidth}{RegistrationTransformation}
  \addsubpic{变形的图谱标签}{width=0.3\textwidth}{RegistrationWarpedAtlasLabel}
\end{pics}
...
\pic[htpb]{分割流程图}{width=0.4\textwidth}{MyMASFlowchart}
\begin{enumerate}
