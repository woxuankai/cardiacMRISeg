...
\pic[htpb]{DET0002701号数据第1帧图像（从上到下、从左到右为心尖到心脏基部）}%
...
\begin{pics}[htpb]{图像相似度测度方法比较}{RegistrationExample}
  ...
  \addsubpic{图谱}{width=0.3\textwidth}{RegistrationAtlas}
  \addsubpic{配准并变形后的图谱}{width=0.3\textwidth}{RegistrationWarpedAtlas}
  \addsubpic{标签传递结果}{width=0.3\textwidth}{RegistrationPrediction}
  \addsubpic{手工分割结果}{width=0.3\textwidth}{RegistrationGroundTruth}
\end{pics}
