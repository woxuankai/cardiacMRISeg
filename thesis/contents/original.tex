...
\chapter{Multi-atlas segmentation of biomedical images: A survey}

\section{Historical introduction and background}

\section{Survey of methodological developments}
\subsection{Generation of atlases}
\subsection{Offline learning}
\subsection{Registration}
\subsection{Altas selection}
\subsection{Label propagation}
\subsection{Online learning}
\subsection{Label fusion}
\subsection{Post-processing}

\section{Survey of application}
